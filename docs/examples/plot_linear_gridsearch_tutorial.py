...
data_loader = linear.Preprocessor("txt")
data = data_loader.load_data("data/rcv1/train.txt", "data/rcv1/test.txt", return_raw=True)
binarizer = MultiLabelBinarizer(sparse_output=True)
y = binarizer.fit_transform(data["train"]["y"]).astype("d")
...
x = vectorizer.fit_transform(data["train"]["x"])
...
y = binarizer.transform(data["test"]["y"]).astype("d").toarray()
