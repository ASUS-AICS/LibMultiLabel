...
#         classes, # model
#         word_dict, # model
#         init_weight=None, # model
#         log_path=None, # model
#         network_config=None, # model
#         learning_rate=0.0001, # MultiLabel
#         optimizer='adam', # MultiLabel
#         momentum=0.9, # MultiLabel
#         weight_decay=0, # MultiLabel
#         metric_threshold=0.5, # MultiLabel
#         monitor_metrics=None, # MultiLabel
#         silent=False, # MultiLabel
#         save_k_predictions=0, # MultiLabel
#         **kwargs
#     ):
#         super().__init__()
