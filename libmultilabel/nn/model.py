...
class Model(MultiLabelModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.save_hyperparameters(ignore=["log_path"]) #If log_path is saved, loading the checkpoint will cause an error since each experiment has unique log_path (result_dir).
