...
def init_model(
    ...
    Args:
        ...
        lr_scheduler (dict, optional): Name of the learning rate scheduler. Defaults to None.
        scheduler_config (dict, optional): Configuration of learning rate scheduler. Defaults to None.
